...
func (h *Handler) RegisterHandler(router *gin.Engine) {
	...
	router.GET("/api/material_orders", h.GetOrdersAPI)
	router.GET("/api/material_orders/:id", h.GetOrderWithMaterialsAPI)
	router.GET("/api/users/:id", h.GetUserAPI)

	router.POST("/material_orders/draft/add/:id", h.AddMaterialToDraftOrder)
	router.POST("/material_orders/delete/:id", h.DeleteMaterialsOrder)
	router.POST("/api/material", h.CreateMaterialAPI)
	router.POST("/api/material_orders/draft/add/:id", h.AddMaterialToDraftOrderAPI)
	router.POST("/api/material/:id/image", h.UploadMaterialImage)
	router.POST("/api/material/:id/delete", h.DeleteMaterialLogicalAPI)
	router.POST("/api/material_orders/delete/:id", h.DeleteMaterialsOrderAPI)
	...
	router.PUT("/api/material_orders/:id", h.UpdateMaterialOrderAPI)
	router.PUT("/api/material_orders/:id/form", h.FormMaterialOrderAPI)
	router.PUT("/api/material_orders/:id/complete", h.CompleteOrRejectOrderAPI)
	router.PUT("/api/material_orders/materials/:order_id/:material_id/wall_length", h.UpdateWallLengthAPI)
	router.PUT("/api/users/:id", h.UpdateUserAPI)

	router.DELETE("/api/material_orders/:order_id/material/:material_id", h.DeleteMaterialFromOrderAPI)
